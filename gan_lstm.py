...
class Param:
    ...
    out_path = '/data/haoran/unet-gan/gan_lstm_4/'
...
class Unet_conv(nn.Module):
    def __init__(self, unet_input_channel = 3):
        super(unet_conv, self).__init__()
        self.conv0 = conv_stage(unet_input_channel, Param.unet_channel)        # 64
        self.conv1 = conv_down(Param.unet_channel, Param.unet_channel * 2)     # 32
        self.conv2 = conv_down(Param.unet_channel * 2, Param.unet_channel * 4) # 16
        self.conv3 = conv_down(Param.unet_channel * 4, Param.unet_channel * 8) #  8
        self.conv4 = conv_down(Param.unet_channel * 8, Param.unet_channel * 8) #  4
...
class Unet_deconv(nn.Module):
    def __init__(self, hidden_channel = Param.unet_channel*8):
